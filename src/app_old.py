    ...
    dbc.CardBody(
        [
            ...
            html.P(
                ...
                Die Umsetzung nutzt den PandasQueryEngine von Llamaindex.""",
                className="card-text"),
...
chatbot_card = dbc.Card(
    dbc.CardBody([
        ...
        dbc.Textarea(
            id="question",
            placeholder=' FRAGE: zB "Wie viele Zeilen hat der Datensatz? ',
            style={"margin-bottom": "1rem", "height": "60px"}
        ),
        dbc.Textarea(
            id="answer",
            placeholder="ANTWORT: 2055",
            style={"margin-bottom": "1rem", "height": "100px"},
            readOnly=True
        ),
    ]),
    body=True,
